...
def test_total_definition_count_is_25() -> None:
    # Current registry includes the 8 marketplace definitions plus newer LLM providers.
    keys = {d.key for d in registry.all()}
    assert len(keys) == 25, sorted(keys)
